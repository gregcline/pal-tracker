...
public class TimeEntryApiTestV1 {
    ...
    public void testCreate() throws Exception {
        ResponseEntity<String> createResponse = restTemplate.postForEntity("/v1/time-entries", timeEntry, String.class);
    ...
    public void testList() throws Exception {
        ...
        ResponseEntity<String> listResponse = restTemplate.getForEntity("/v1/time-entries", String.class);
    ...
    public void testRead() throws Exception {
        ...
        ResponseEntity<String> readResponse = this.restTemplate.getForEntity("/v1/time-entries/" + id, String.class);
    ...
    public void testUpdate() throws Exception {
        ...
        ResponseEntity<String> updateResponse = restTemplate.exchange("/v1/time-entries/" + id, HttpMethod.PUT, new HttpEntity<>(updatedTimeEntry, null), String.class);
    ...
    public void testDelete() throws Exception {
        ...
        ResponseEntity<String> deleteResponse = restTemplate.exchange("/v1/time-entries/" + id, HttpMethod.DELETE, null, String.class);
    ...
    private Long createTimeEntry() {
        ...
        ResponseEntity<TimeEntry> response = restTemplate.exchange("/v1/time-entries", HttpMethod.POST, entity, TimeEntry.class);
